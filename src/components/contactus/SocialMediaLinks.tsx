...
const SocialMediaIcons = () => {
  return (
    <div className="flex items-center gap-4 flex-wrap">
      ...
      <div className="social-button">
        <a
        href="https://www.youtube.com/@NexifyDigital-78"
        target="_blank"
        rel="noopener noreferrer">
        <button className="relative w-12 h-12 cursor-pointer rounded-full group">
      ...
      <div className="social-button">
        <a
        href="https://in.pinterest.com/nexifyd"
        target="_blank"
        rel="noopener noreferrer">
        <button className="relative w-12 h-12 cursor-pointer rounded-full group">
          <div className="floater w-full h-full absolute top-0 left-0 bg-orange-700 rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
          <div className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-orange-700 rounded-full">
            <FaPinterestP className="text-white group-hover:text-[#b7b5e0] duration-300" size={22} />
          </div>
        </button>
        </a>
      </div>
      ...
      <div className="social-button">
        <a
        href="https://www.threads.com/@nexifydigital.in"
        target="_blank"
        rel="noopener noreferrer">
        <button className="relative w-12 h-12 cursor-pointer rounded-full group">
          <div className="floater w-full h-full absolute top-0 left-0 bg-black rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
          <div className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-black rounded-full">
            <SiThreads className="text-white group-hover:text-[#b7b5e0] duration-300" size={22} />
          </div>
        </button>
        </a>
      </div>
